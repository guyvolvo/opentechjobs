...
TOPBAR = """<body class="job-page-body">
  <div class="topbar">
    <div class="container">
      <div class="topbar-left"><a class="topbar-mark" href="/" aria-label="Ocean of Jobs home"><img src="/favicon.svg?v=3" width="22" height="22" alt="" /></a><nav class="topbar-nav" aria-label="Site"><a href="/board">Jobs</a><a href="/stats">Statistics</a><a href="/api/help">API</a></nav></div>
    </div>
  </div>
"""
