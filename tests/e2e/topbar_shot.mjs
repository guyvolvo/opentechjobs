...
for (const [name, opts, path] of [["board-desktop", { viewport: { width: 1400, height: 300 } }, "/board"], ["board-desktop-dark", { viewport: { width: 1400, height: 300 }, colorScheme: "dark" }, "/board"], ["account-desktop", { viewport: { width: 1400, height: 300 } }, "/account"], ["board-phone", { ...devices["iPhone 13"] }, "/board"]]) {
  ...
  await page.goto(origin + path, { waitUntil: "load" }); await page.waitForTimeout(4500);
