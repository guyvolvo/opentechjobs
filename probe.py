...
from localtime import israel_local_to_utc  # noqa: E402
...
_SENIORITY_RULES: list[tuple[str, "re.Pattern[str]"]] = [
    ...
    for level, needles in [
        ...
        ("principal", ["principal"]),
        ("staff", ["staff"]),
        # "leader" spelled out, not just "lead": \b makes "Team Leader"
...
def f_redmatch(sess, token, known_ids=None, description_budget=None):
    ...
    for j in d:
        ...
        out.append(Job("redmatch", token, pid, title,
                       ...
                       israel_local_to_utc(_txt(j.get("activationDate"))) or None,
